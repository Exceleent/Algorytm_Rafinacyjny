...
public:
    ...
    static std::vector<Node::rodzaj_zasobu> zasobyNajszybsze;
    static std::vector<Node::rodzaj_zasobu> zasobyNajtansze;
    static std::vector<Node::rodzaj_zasobu> zasobyNajmniejszyIloczynCzasuIKosztu;
...
private:
    ...
    void uzupelnijZasobNajtanszy();
    void uzupelnijZasobNajszybszy();
    void uzupelnijZasobKtoregoIloczynNajmniejszy();
...
public:
    std::vector<Node>  zwrocZbiorZadan() const;
    std::vector<Node::numer_zadania >  zwrocListeSasiedztwa() const;
    void zamienZbiorZadanNaListeSasiedztwa();
    void wydrukujListeSasiedztwa() ;
    void zamienListeSasiedztwaNaZbiorZadan();
    void print();
    std::size_t liczbaZadanWGrafie() const;
